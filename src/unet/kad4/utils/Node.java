...
public class Node {
    ...
    */
    ...
    public Node(String uid, InetAddress address, int port, PublicKey publicKey){
        this(new UID(uid), new InetSocketAddress(address, port), publicKey);
    }

    public Node(String uid, InetSocketAddress address, PublicKey publicKey){
        this(new UID(uid), address, publicKey);
    }

    public Node(byte[] bid, InetAddress address, int port, PublicKey publicKey){
        this(new UID(bid), new InetSocketAddress(address, port), publicKey);
    }

    public Node(byte[] bid, InetSocketAddress address, PublicKey publicKey){
        this(new UID(bid), address, publicKey);
    }

    public Node(UID uid, InetAddress address, int port, PublicKey publicKey){
        this(uid, new InetSocketAddress(address, port), publicKey);
    }

    public Node(UID uid, InetSocketAddress address, PublicKey publicKey){
        this.uid = uid;
        this.address = address;
